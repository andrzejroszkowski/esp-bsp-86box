...
#define BSP_LCD_DATA6_GPIO      (2)
#define BSP_LCD_DATA7_GPIO      (46)
#define BSP_LCD_DATA8_GPIO      (9)
#define BSP_LCD_DATA9_GPIO      (1)
#define BSP_LCD_DATA10_GPIO     (3)
#define BSP_LCD_DATA11_GPIO     (42)
#define BSP_LCD_DATA12_GPIO     (21)
#define BSP_LCD_DATA13_GPIO     (15)
#define BSP_LCD_DATA14_GPIO     (16)
#define BSP_LCD_DATA15_GPIO     (17)

#define BSP_I2C_SDA_GPIO        (19)
#define BSP_I2C_SCL_GPIO        (20)
#define BSP_TOUCH_INT_GPIO      (18)
#define BSP_TOUCH_RST_GPIO      (38)
